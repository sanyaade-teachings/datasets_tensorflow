  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    return tfds.core.DatasetInfo(
        ...
        features=tfds.features.FeaturesDict({
            ...
            'zpve_thermo': tfds.features.Tensor(shape=(), dtype=np.float32),
            'U0_thermo': tfds.features.Tensor(shape=(), dtype=np.float32),
            'U_thermo': tfds.features.Tensor(shape=(), dtype=np.float32),
            'H_thermo': tfds.features.Tensor(shape=(), dtype=np.float32),
            'G_thermo': tfds.features.Tensor(shape=(), dtype=np.float32),
            'Cv_thermo': tfds.features.Tensor(shape=(), dtype=np.float32),
